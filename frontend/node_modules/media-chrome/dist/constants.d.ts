export namespace MediaUIEvents {
    ...
    const MEDIA_TOGGLE_SUBTITLES_REQUEST: string;
    const MEDIA_PLAYBACK_RATE_REQUEST: string;
    const MEDIA_RENDITION_REQUEST: string;
    const MEDIA_AUDIO_TRACK_REQUEST: string;
...
export namespace MediaStateChangeEvents {
    ...
    const MEDIA_RENDITION_UNAVAILABLE_2: string;
    export { MEDIA_RENDITION_UNAVAILABLE_2 as MEDIA_RENDITION_UNAVAILABLE };
    const MEDIA_AUDIO_TRACK_UNAVAILABLE_2: string;
    export { MEDIA_AUDIO_TRACK_UNAVAILABLE_2 as MEDIA_AUDIO_TRACK_UNAVAILABLE };
    ...
    const MEDIA_IS_AIRPLAYING_2: string;
    export { MEDIA_IS_AIRPLAYING_2 as MEDIA_IS_AIRPLAYING };
    ...
    const MEDIA_RENDITION_LIST_2: string;
    export { MEDIA_RENDITION_LIST_2 as MEDIA_RENDITION_LIST };
    const MEDIA_RENDITION_SELECTED_2: string;
    export { MEDIA_RENDITION_SELECTED_2 as MEDIA_RENDITION_SELECTED };
    const MEDIA_AUDIO_TRACK_LIST_2: string;
    export { MEDIA_AUDIO_TRACK_LIST_2 as MEDIA_AUDIO_TRACK_LIST };
    const MEDIA_AUDIO_TRACK_ENABLED_2: string;
    export { MEDIA_AUDIO_TRACK_ENABLED_2 as MEDIA_AUDIO_TRACK_ENABLED };
